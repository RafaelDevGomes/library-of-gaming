...
# O projeto Library of Gaming consiste no desenvolvimento de uma plataforma online dedicada à análise e avaliação de jogos eletrônicos. O principal objetivo do site é oferecer aos usuários um ambiente confiável e organizado para consultar opiniões, avaliações e informações sobre diferentes títulos do mercado de games.
...
Arthur Seabra de Mesquita
Felipe Willyam da Cunha Silva
João Pedro dos Santos Machado Ramos
